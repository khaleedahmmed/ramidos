...
<label>{{ __('admin.imgage')}}</label>
<div class="custom-file-container" data-upload-id="myFirstImage">
        <a href="javascript:void(0)" class="custom-file-container__image-clear" title="Clear Image">x</a>
        <label class="custom-file-container__custom-file" >
            <input name="ima" type="file" class="custom-file-container__custom-file__custom-file-input" accept="image/*">
    ...
    @if(isset($item))
    <div class="m-2">
        <img width="100px"  src=" {{ isset($item->img) ? url("/uploads/abouts/".$item->img) : null }}">
        </div>
    @endif
</div>
 @section('scripts')
