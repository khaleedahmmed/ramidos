    ...
    <div class="row layout-top-spacing">
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6">
                <a href="{{ url('admin/clients/create') }}" style="float:right" class="btn btn-primary">{{ __('admin.add') }} {{ __('admin.client') }}</a>
                    ...
                    <div>
                        ...
                        <table class="table table-hover" style="width:100%" id="areas-table">
                            ...
                            @foreach ($items as $item)
                                <tr>
                                    <td>{{ $item->name }}</td>
                                    <td> <img width="100px"  src=" {{ isset($item->img) ? url("/images/clients/".$item->img) : null }}"></td>
                                    <td>
                                        <div class="row">
                                            <div class="col-lg-1">
