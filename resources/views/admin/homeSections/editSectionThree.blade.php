...
@section('title')
{{__('admin.edit')}} {{__('admin.sectionThree')}}
                  ...
                  <div class="widget-header">                                
                      <div class="row">
                          <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                              <h4>{{__('admin.edit')}} {{__('admin.sectionThree')}}
                              </h4>
                          </div>                                                                        
                      </div>
                  </div>
                  <div class="widget-content widget-content-area">
                    <form action="{{ route('sectionThree.update',$item) }}" method="POST" enctype="multipart/form-data">
                      @csrf
                      @include('admin.homeSections.formsectionThree')

                      <x-submit redirectRoute="{{ route('sectionThree.index') }}">{{ isset($item) ? __('admin.edit') : __('admin.add') }}</x-submit>
                    </form>
