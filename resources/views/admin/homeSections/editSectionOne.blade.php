...
@section('title')
{{__('admin.edit')}} {{__('admin.sectionOne')}}
                  ...
                  <div class="widget-header">                                
                      <div class="row">
                          <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                              <h4>{{__('admin.edit')}} {{__('admin.sectionOne')}}
                              </h4>
                          </div>                                                                        
                      </div>
                  </div>
                  <div class="widget-content widget-content-area">
                    <form action="{{ route('sectionOne.update',$item) }}" method="POST" enctype="multipart/form-data">
                      @csrf
                      @include('admin.homeSections.formSectionOne')

                      <x-submit redirectRoute="{{ route('sectionOne.index') }}">{{ isset($item) ? __('admin.edit') : __('admin.add') }}</x-submit>
                    </form>
